            ...
            <div class="row center mb-5" >
                <div class="col-md-12 ">
                    <!-- @if($errors->any())
                        ...
                        @endforeach
                    @endif -->
                    <form action="store" id="frm" method="POST" class="ml-5 mt-2" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-11">
                        ...
                        <!-- @if($errors->any())
                            @foreach($errors->get('name') as $msg)
                             <script>
                                ...
                                <span style="color: red;"> toastr.error('required')</span>
                            @endforeach
                        @endif -->
                        <div class="col-md-11">
                            <div class="form-group">
                    ...
                    @endif -->
                        ...
                        <div class="col-md-11">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" name="skills[]" value="python" class="form-check-input">
                                    <label for="" class="form-check-label">PYTHON</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" name="skills[]" value="c#" class="form-check-input">
...
<!-- @elseif($errors->any())
        ...
        @foreach($errors->get('email') as $msg1)
        <script>
        if({{$errors->has('email')}})
        {
        toastr.error("{{$msg1}}");
